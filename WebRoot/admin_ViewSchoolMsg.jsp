...
<script type="text/javascript" language="javascript">
	...
	function oK() {
		...
		window.location.href = "Admin_ViewSchoolMsg?currentPage=" + currentPage;
	}
</script>
</head>
...
<body>
							...
							<tr>
								<c:forEach var="msg" items="${schoolMsgList}">
									<tr>
										...
										<td><c:out value="${msg.schoolName}"></c:out></td>
						...
						<thead>
							...
							<tr valign="middle">
								...
								<td colspan="3" class="bg_tr" align="right"><a
									href="Admin_ViewSchoolMsg?currentPage=1">首页&nbsp;</a> <%
 	if (currentPage > 1) {
 %> <a href="Admin_ViewSchoolMsg?currentPage=<%=currentPage - 1%>">上一页&nbsp;</a>
									<%
										} else {
									%>上一页&nbsp;<%
										}
 ...
 %> <a href="Admin_ViewSchoolMsg?currentPage=<%=currentPage + 1%>">下一页&nbsp;</a>
									<%
										} else {
									%>下一页&nbsp;<%
										}
									%> <a href="Admin_ViewSchoolMsg?currentPage=<%=allpage%>">尾页&nbsp;</a>
