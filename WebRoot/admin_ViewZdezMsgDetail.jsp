<%@page import="cn.com.zdez.vo.ZdezMsgVo"%>
...
<%
		...
		zdezMsgVo = (ZdezMsgVo) request.getAttribute("zdezMsg");
		currentPage = (Integer) session.getAttribute("currentPage");
		type = (Integer) session.getAttribute("type");
		filePath = "/zdezServer/attached/html/zdezMsg"
				+ Integer.toString(zdezMsgVo.getZdezMsgId()) + ".html";
	}
%>
...
<body>
	...
	<div class="submit_link">
		<%
			if (type == 1) {
		%>
		<a href="Admin_ViewZdezMsg?currentPage=<%=currentPage%>"> <input
		...
		<a
			href="Admin_ViewZdezMsgQuery?currentPage=<%=currentPage%>&keyword=<%=keyword%>">
