...
<script type="text/javascript" language="javascript">
	...
	function oK() {
		...
		window.location.href = "Admin_ViewNews?currentPage=" + currentPage;
	}
</script>
</head>
...
<body>
	...
	<section id="main" class="column">
		...
		<article class="module width_full">
			...
			<form class="quick_search" action="Admin_ViewNewsQuery"
				method="get">
			...
			<div class="tab_container">
				<div id="tab1" class="tab_content">
					<table class="tablesorter" cellspacing="0">
						...
						<tbody>
							<tr>
								<c:forEach var="msg" items="${newsList}">
									<tr>
										...
										<td><a
											href="Admin_ViewNewsDetail?newsId=${msg.id}">
												<input type="image" src="images/icn_alert_info.png"
												title="查看"> </a><a
											href="Admin_NewsResend?newsId=${msg.id}"> <input
						...
						<thead>
							...
							<tr valign="middle">
								...
								<td colspan="3" class="bg_tr" align="right"><a
									href="Admin_ViewNews?currentPage=1">首页&nbsp;</a> <%
 	if (currentPage > 1) {
 %> <a href="Admin_ViewNews?currentPage=<%=currentPage - 1%>">上一页&nbsp;</a>
									<%
										} else {
									%>上一页&nbsp;<%
										}
 ...
 %> <a href="Admin_ViewNews?currentPage=<%=currentPage + 1%>">下一页&nbsp;</a>
									<%
										} else {
									%>下一页&nbsp;<%
										}
									%> <a href="Admin_ViewNews?currentPage=<%=allpage%>">尾页&nbsp;</a>
