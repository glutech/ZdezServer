...
<script type="text/javascript" language="javascript">
	...
	function oK() {
		...
		window.location.href = "Admin_ViewZdezMsgQuery?currentPage="
...
<body>
	...
	<section id="main" class="column">
		...
		<article class="module width_full">
			...
			<form class="quick_search" action="Admin_ViewZdezMsgQuery"
				method="get">
			...
			<div class="tab_container">
				<div id="tab1" class="tab_content">
					<table class="tablesorter" cellspacing="0">
						...
						<tbody>
							<tr>
								<c:forEach var="msg" items="${zdezMsgList}">
									<tr>
										...
										<td><a href="Admin_ViewZdezMsgDetail?zdezMsgId=${msg.zdezMsgId}">
												<input type="image" src="images/icn_alert_info.png"
												title="查看"> </a><a
											href="Admin_ZdezMsgResend?zdezMsgId=${msg.zdezMsgId}"> <input
						...
						<thead>
							...
							<tr valign="middle">
								...
								<td colspan="3" class="bg_tr" align="right"><a
									href="Admin_ViewZdezMsgQuery?currentPage=1&keyword=<%=keyword%>">首页&nbsp;</a>
									<%
										if (currentPage > 1) {
									%> <a
									href="Admin_ViewZdezMsgQuery?currentPage=<%=currentPage - 1%>&keyword=<%=keyword%>">上一页&nbsp;</a>
									<%
										} else {
									%>上一页&nbsp;<%
										}
 ...
 %> <a
									href="Admin_ViewZdezMsgQuery?currentPage=<%=currentPage + 1%>&keyword=<%=keyword%>">下一页&nbsp;</a>
									<%
										} else {
									%>下一页&nbsp;<%
										}
									%> <a
									href="Admin_ViewZdezMsgQuery?currentPage=<%=allpage%>&keyword=<%=keyword%>">尾页&nbsp;</a>
