...
<script type="text/javascript" language="javascript">
	...
	function oK() {
		...
		window.location.href = "Admin_ViewZdezMsg?currentPage=" + currentPage;
	}
</script>
</head>
...
<body>
							...
							<tr>
								<c:forEach var="msg" items="${zdezMsgList}">
									<tr>
										...
										<td><c:out value="${msg.receivedNum}"></c:out>/<c:out value="${msg.receiverNum}"></c:out></td>
										<td><a
											href="Admin_ViewZdezMsgDetail?zdezMsgId=${msg.zdezMsgId}">
						...
						<thead>
							...
							<tr valign="middle">
								...
								<td colspan="3" class="bg_tr" align="right"><a
									href="Admin_ViewZdezMsg?currentPage=1">首页&nbsp;</a> <%
 	if (currentPage > 1) {
 %> <a href="Admin_ViewZdezMsg?currentPage=<%=currentPage - 1%>">上一页&nbsp;</a>
									<%
										} else {
									%>上一页&nbsp;<%
										}
 ...
 %> <a href="Admin_ViewZdezMsg?currentPage=<%=currentPage + 1%>">下一页&nbsp;</a>
									<%
										} else {
									%>下一页&nbsp;<%
										}
									%> <a href="Admin_ViewZdezMsg?currentPage=<%=allpage%>">尾页&nbsp;</a>
