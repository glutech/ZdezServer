...
public class AndroidClient_UpdateSchoolMsgReceived extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public AndroidClient_UpdateSchoolMsgReceived() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		service.updateSchoolMsgReceived(ack.getUserId(), ids);
	}
