...
<script type="text/javascript" language="javascript">
	...
	function oK() {
		...
		window.location.href = "Admin_ViewNewsQuery?currentPage="
...
<body>
						...
						<thead>
							...
							<tr valign="middle">
								...
								<td colspan="3" class="bg_tr" align="right"><a
									href="Admin_ViewNewsQuery?currentPage=1&keyword=<%=keyword%>">首页&nbsp;</a>
									<%
										if (currentPage > 1) {
									%> <a
									href="Admin_ViewNewsQuery?currentPage=<%=currentPage - 1%>&keyword=<%=keyword%>">上一页&nbsp;</a>
									<%
										} else {
									%>上一页&nbsp;<%
										}
 ...
 %> <a
									href="Admin_ViewNewsQuery?currentPage=<%=currentPage + 1%>&keyword=<%=keyword%>">下一页&nbsp;</a>
									<%
										} else {
									%>下一页&nbsp;<%
										}
									%> <a
									href="Admin_ViewNewsQuery?currentPage=<%=allpage%>&keyword=<%=keyword%>">尾页&nbsp;</a>
