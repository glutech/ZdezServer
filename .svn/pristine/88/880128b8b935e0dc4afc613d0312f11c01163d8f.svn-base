...
public class Admin_NewStudentHref extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public Admin_NewStudentHref() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("admin_NewStudent.jsp").forward(request, response);
	}
