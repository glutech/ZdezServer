...
<body>
						...
						<thead>
							...
							<tr valign="middle">
								...
								<td colspan="3" class="bg_tr" align="right"><a
									href="School_SendedMsgQuery?currentPage=1&keyword=<%=keyword%>">首页&nbsp;</a>
									<%
										if (currentPage > 1) {
									%> <a
									href="School_SendedMsgQuery?currentPage=<%=currentPage - 1%>&keyword=<%=keyword%>">上一页&nbsp;</a>
									<%
										} else {
									%>上一页&nbsp;<%
										}
 ...
 %> <a
									href="School_SendedMsgQuery?currentPage=<%=currentPage + 1%>&keyword=<%=keyword%>">下一页&nbsp;</a>
									<%
										} else {
									%>下一页&nbsp;<%
										}
									%> <a
									href="School_SendedMsgQuery?currentPage=<%=allpage%>&keyword=<%=keyword%>">尾页&nbsp;</a>
