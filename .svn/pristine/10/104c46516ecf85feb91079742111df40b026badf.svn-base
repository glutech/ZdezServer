...
public class Admin_ViewSchoolMsgQuery extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int all = service.getSchoolMsgQueryCount(keyword); // 一共多少条记录
		...
		sMsgToBeDisplayed = service.getSchoolMsgQueryByPage(start, end,
				keyword);
		...
		request.getRequestDispatcher("admin_ViewSchoolMsgQuery.jsp").forward(
				request, response);
	}
